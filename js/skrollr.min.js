...
(function(e, t, n) {
    ...
    function j(n) {
        ...
        nt = {
            ...
            render: n.render
        }, rt = n.forceHeight !== !1, ht = n.smoothScrolling !== !1, pt = {
            targetTop: et.getScrollTop()
        }, rt && (ot = n.scale || 1), K(s, [l], [c]);
        if (rt) {
            ...
            a.minWidth = "1px", a.position = "absolute", a.top = a.zIndex = "0", u.id || (a.width = "1px", a.right = "0", o.appendChild(u)), st = function() {
                it = 0, F(), a.height = it + s.clientHeight + "px", dt = !0, r.iscroll && e.setTimeout(function() {
                    r.iscroll.refresh()
                }, 0)
            }
        } else st = function() {
    ...
    j.prototype.refresh = function(e) {
        ...
        }, ct.topDiff || (ct.done && ct.done.call(et, !1), ct = n), et
    ...
    var F = function() {
        ...
        q = function() {
            var e = et.getScrollTop(),
                t, r = Y(),
                i;
            if (ct) r >= ct.endTime ? (e = ct.targetTop, t = ct.done, ct = n) : (i = ct.easing((r - ct.startTime) / ct.duration), e = ct.startTop + i * ct.topDiff | 0), et.setScrollTop(e);
            else {
            ...
            if (dt || ft !== e) {
                ...
                var o = {
                    ...
                    u = nt.beforerender && nt.beforerender.call(et, o);
